...
/**
 * this class represent the command for displaying the weighted portfolio.
 */
public class DisplayWeightedPfHelper implements CommandController {
  ...
  public void goCommand(PortfolioStrategyModel model, PortfolioView view, Scanner scan) {
    ...
    view.output(model.displayWeightedPf(portfolioName));
  }
}
